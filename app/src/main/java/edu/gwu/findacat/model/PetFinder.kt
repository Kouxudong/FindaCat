...
import edu.gwu.trivia.model.generated.petfinder1.PetfinderResponse
...
class PetFinderManager(private val context: Context, private val location: String) {
    ...
    interface ApiEndpointInterface {
        @GET("pet.find")        fun findPets(@Query("key") key: String, @Query("format") format: String, @Query("animal") animal: String, @Query("location") location: Int): Call<PetfinderResponse>

    }
    fun searchPets(zipcode:String) {
        ...
        apiEndpoint.findPets("0b1452a0af588b352bf732936fa8219b", "json", "cat", Integer.parseInt(location)).enqueue(object: Callback<PetfinderResponse> {
